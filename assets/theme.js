...
var Product = /*#__PURE__*/function () {
  ...
  _createClass(Product, [{
    ...
    value: function onFormSubmit(e) {
      ...
      var isQuickProductForm = Boolean(e.target.closest(".quick-product"));
      ...
      if (!purchaseConfirmation && !quickCart && !isQuickProductForm) return;
      e.preventDefault();
...
var FilterForm = function FilterForm(node) {
  ...
  function renderFilters(doc) {
    var updatedFilterItems = t$2("".concat(selectors$7.scopedForm(formType), " ").concat(selectors$7.filterItem), doc);
    updatedFilterItems.forEach(function (element) {
      replaceElement("".concat(selectors$7.scopedForm(formType), " ").concat(selectors$7.filterItem, "[for=\"").concat(element.getAttribute("for"), "\"] .filter-item__checkbox"), doc);
      replaceElement("".concat(selectors$7.scopedForm(formType), " ").concat(selectors$7.filterItem, "[for=\"").concat(element.getAttribute("for"), "\"] .filter-item__count"), doc);
    });
...
register("collection", {
  ...
  _renderView: function _renderView(searchParams) {
    ...
    u$1(this.filterDrawerEl, classes$1.loading);
