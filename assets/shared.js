...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (_ref => {
  ...
  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default().createElement("div", {
    ...
    image_aspect_ratio: desktopratio
  }))), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default().createElement("div", {
    ...
    style: {
      "--text-horizontal-position": "".concat(positionHorizontal),
      "--text-vertical-position": "".concat(positionVertical),
      "--text-alignment": "left",
    ...
    style: {
      "text-align": "".concat(positionHorizontal),
      "--text-alignment-mobile": "".concat(positionHorizontal)
    }
