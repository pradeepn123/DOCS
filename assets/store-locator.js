...
/* unused harmony default export */ var __WEBPACK_DEFAULT_EXPORT__ = (() => {
  document.querySelectorAll('[data-dropdown-wrapper]').forEach(dropdown => {
    ...
    var toggleDropdown = () => {
      var _dropdownSelect, _caret, _menu;
      (_dropdownSelect = dropdownSelect) === null || _dropdownSelect === void 0 || _dropdownSelect.classList.toggle('select-clicked');
      (_caret = caret) === null || _caret === void 0 || _caret.classList.toggle('caret-rotate');
      (_menu = menu) === null || _menu === void 0 || _menu.classList.toggle('menu-open');
    };
    (_dropdownSelect2 = dropdownSelect) === null || _dropdownSelect2 === void 0 || _dropdownSelect2.addEventListener('click', toggleDropdown);
...
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["vendors"], () => (__webpack_require__("./js/sections/store-locator.js")))
